...
public class User extends DTO {
	...
	@OneToMany(fetch = FetchType.EAGER)
	@JoinColumn(name="ownerid")
	private List<com.critters.dal.entity.Store> store;
	...
	public User(int userID, String userName, String firstName, String lastName, String emailAddress, String password, String sex, int birthMonth, int birthDay,
				...
				int critterbuxx, List<Friendship> friends, List<Friendship> friendsOf, boolean isActive, List<com.critters.dal.entity.Store> store, String userImagePath) {
		this.userID = userID;
	...
	public List<com.critters.dal.entity.Store> getStore(){
		if((inventory instanceof PersistentBag && ((PersistentBag)inventory).wasInitialized()) || inventory instanceof ArrayList) {
			return this.store;
		} else {
			return null;
	...
	public void setStore(List<com.critters.dal.entity.Store> store){
		this.store = store;
	}

...
// From https://github.com/sksamuel/gwt-websockets
...
public class Websocket {
    ...
    private native void _open(Websocket ws, String s, String url) /*-{
        ...
        $wnd[s].onopen = function() { ws.@com.critters.breakout.net.Websocket::onOpen()(); };
        $wnd[s].onclose = function(evt) { ws.@com.critters.breakout.net.Websocket::onClose(SLjava/lang/String;Z)(evt.code, evt.reason, evt.wasClean); };
        $wnd[s].onerror = function() { ws.@com.critters.breakout.net.Websocket::onError()(); };
        $wnd[s].onmessage = function(msg) { ws.@com.critters.breakout.net.Websocket::onMessage(Ljava/lang/String;)(msg.data); }
    }-*/;
